<nav class="navbar-top" role="navigation"> 
  ...
  <div class="nav-top"> 
    ...
    <ul class="nav navbar-right">
      ...
      <li class="dropdown user-box"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">  <span class="user-info">
        <?php if($_SESSION['loginRole']=='superadmin') { echo "Unixsurfactants"; } else { echo $_SESSION['loginRole'];  }?>
