        ...
        <div class="col-lg-12"> 
          ...
          <div class="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active"><a href="<?php echo URL; ?>register.php">Contact US Persons</a></li>
            </ul>
          ...
          <div class="page-header title"> 
            <!-- PAGE TITLE ROW -->
            <h1>Admin <span class="sub-title"><a href="<?php echo URL; ?>regestation.php">Contact US Persons</a></span></h1>
          </div>
          <!-- /#ek-layout-button -->
          ...
          <div class="portlet table-responsive"><!-- /Portlet -->
            <div class="portlet-heading dark">
              <div class="portlet-title">
                <h4>Contact US Persons(<?php echo $total; ?>)</h4>
              </div>
